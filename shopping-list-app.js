document.addEventListener('DOMContentLoaded', () => {
    ...
    let boughtSVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M173.898 439.404l-166.4-166.4c-9.997-9.997-9.997-26.206 0-36.204l36.203-36.204c9.997-9.998 26.207-9.998 36.204 0L192 312.69 432.095 72.596c9.997-9.997 26.207-9.997 36.204 0l36.203 36.204c9.997 9.997 9.997 26.206 0 36.204l-294.4 294.401c-9.998 9.997-26.207 9.997-36.204-.001z"/></svg>`;
    ...
    function addItemGrocery(text) {
        // grab the `ul`
        let list = document.getElementById("shopping");
        // create an `li`
        ...
        //create container for our buttons remove and bought
        ...
        // add the SVG icon to the button
        bought.innerHTML = boughtSVG;
        // add event listener for bought
        // this function will be defined later
        bought.addEventListener("click", boughtItem);

        // append the buttons to the div
        buttons.appendChild(remove);
        buttons.appendChild(bought);
    ...
    function boughtItem() {
        ...
        let target = (id === "shopping") ? document.getElementById("bought") : document.getElementById("shopping");
